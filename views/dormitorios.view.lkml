view: dormitorios {
  derived_table: {
    sql: SELECT * FROM [propins-web:informes_mayo_2023.junio_2023] WHERE
      Comuna ='Independencia'AND Barrio='Hospitales' AND TipoPropiedad='Departamento' AND Dormitorios=2 ;;
  }
